...
# unit 11 - graphics
#
# a scene with layered rain and dog
...
# sounds
pygame.mixer.music.load("bark.ogg")
bark = pygame.mixer.Sound("bark.ogg")

pygame.mixer.music.load("dog_theme.ogg")
song = pygame.mixer.Sound("dog_theme.ogg")
pygame.mixer.music.play(-1)

# dog
dog = pygame.image.load('dog_2.png')
pygame.image.load('dog_2_flip.png')
pygame.transform.scale(dog, (100, 80))
dog_loc = [200, 400]
dog_vel = [0, 0]
dog_speed = 5

def draw_dog(dog_loc):
    screen.blit(dog, dog_loc)
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_SPACE:
                ...
                dog = pygame.image.load('dog_2_flip.png')
                dog_vel[0] = dog_speed
            elif event.key == pygame.K_LEFT:
                dog = pygame.image.load('dog_2.png')
                dog_vel[0] = -1 * dog_speed
            elif event.key == pygame.K_UP:
                dog_vel[1] = -1 * dog_speed
